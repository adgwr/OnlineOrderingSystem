					...
					<form id="form1" name="form1" method="post" action="" accept-charset="UTF-8" onsubmit="document.charset='UTF-8';">
						<div class="item col-xs-12">
							...
							<div class="f-fl item-ifo">
								<input type="text" name="receiverName" maxlength="20"
						...
						<div class="item col-xs-12">
							...
							<div class="f-fl item-ifo">
								<input type="text" name="address" class="txt03 f-r3 required"
						...
						<div class="item col-xs-12">
							...
							<div class="f-fl item-ifo">
								<input type="text" name="tel" class="txt03 f-r3 required"
						...
						<div class="item col-xs-12">
							...
							<div class="f-fl item-ifo">
								<a href="javascript:;" class="btn btn-blue f-r3" id="btn_part1">添加</a>
							</div>
						</div>
					</form>
...
$(function(){	
	...
	$("#btn_part1").click(function(){
		...
		document.form1.action="AddReceiver";
