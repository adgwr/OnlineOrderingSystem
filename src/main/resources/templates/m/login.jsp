				...
				<div class="content">
					...
					<div id="login" style="margin-top:60px" class="input_control">
						<form name="f"  action="${pageContext.request.contextPath}/login" method="POST">
							<p style="font-size: 2em; color: white;text-align:center;">欢迎登陆网上订餐系统</p>
							<p style="margin-top:60px;text-align:center;">
							<label style="color: white;font-size:1.4em">账号：</label>
							<input type="text"
								...
								onclick="JavaScript:this.value=''" /> </p>
								...
								onclick="JavaScript:this.value=''" /></p>
								<p style="margin-top:30px;margin-bottom:200px;text-align:center;"><input type="button"
								value="登        陆"
